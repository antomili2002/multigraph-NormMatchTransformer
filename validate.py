...
def validate_model(model, dataloader, criterion, eval_epoch=None, verbose=False):
    ...
    for i, cls in enumerate(classes):
        ...
        for k, inputs in enumerate(dataloader):
            ...
            acc, _acc_match_num, _acc_total_num = matching_accuracy(s_pred_mat_list[0], perm_mat_list[0])
        ...
        metrics = {"ep_loss": epoch_loss, "ep_acc": epoch_acc, "ep_f1": epoch_f1}
    ...
    return accs, f1_scores, epoch_loss
